...
func (scanner *Scanner) newRTPSscan(ctx context.Context, dialGroup *zgrab2.DialerGroup, t *zgrab2.ScanTarget) *scan {
	return &scan{
		ctx:       ctx,
		dialGroup: dialGroup,
		scanner:   scanner,
...
func (scanner *Scanner) Scan(ctx context.Context, dialGroup *zgrab2.DialerGroup, t *zgrab2.ScanTarget) (zgrab2.ScanStatus, interface{}, error) {
	scan := scanner.newRTPSscan(ctx, dialGroup, t)
...
func (s *scan) Grab() *zgrab2.ScanError {
	conn, err := s.dialGroup.Dial(s.ctx, s.target)
	if err != nil {
