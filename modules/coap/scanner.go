...
func (scanner *Scanner) newCoAPscan(ctx context.Context, dialGroup *zgrab2.DialerGroup, t *zgrab2.ScanTarget) *scan {
	ret := &scan{
		target:  t,
		scanner: scanner,
	}
...
func (scanner *Scanner) Scan(ctx context.Context, dialGroup *zgrab2.DialerGroup, target *zgrab2.ScanTarget) (zgrab2.ScanStatus, any, error) {
	scan := scanner.newCoAPscan(ctx, dialGroup, target)
